...
taxa <- read.table(snakemake@params[["taxonomy"]], header = TRUE, sep = "\t", check.names = 
FALSE)
...
samples <- unlist(strsplit(snakemake@params[["pos"]], split = "\\|"))
...
if (length(samples) > 0 && !all(samples == "")) {
  ...
  source("utils/scripts/dada2/pos_ctrl_references.R")

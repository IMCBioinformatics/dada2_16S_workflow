...
files <- list.files(path = snakemake@input[["ASVLength"]], pattern = "S1", full.names =TRUE)
...
files <- list.files(path = snakemake@input[["ASVLength"]], pattern = "S2", full.names =TRUE)
...
files <- list.files(path = snakemake@input[["ASVLength"]], pattern = "S3", full.names =TRUE)
...
files <- list.files(path = snakemake@input[["ASVLength"]], pattern = "S4", full.names =TRUE)
...
files <- list.files(path = snakemake@input[["ASVLength"]], pattern = "S5", full.names =TRUE)

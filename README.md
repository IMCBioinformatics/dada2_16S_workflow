...
4- **DECIPHER & FastTreeMP**: performing multiple sequence alignment by DECIPHER, and constructing a phylogenetic tree by FastTreeMP.
...
| path | path to the main snakemake directory | "/home/analysis/dada2_16S_workflow" |
